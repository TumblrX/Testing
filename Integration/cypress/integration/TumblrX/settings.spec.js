...
//     // passwords doesn't match new with the confirm
//     it("Passwords don't match",function(){

//         doesntMatchPasswords(SETTINGS_VARIABLES.oldPassword,SETTINGS_VARIABLES.newPassword,SETTINGS_VARIABLES.ALERT_NOMATCH_MESSAGE)
//     })
//     // passwords doesn't match and empty current password
//     it("Empty password and doesn't match",function(){
//         EmptyPasswordAndNoMatch(SETTINGS_VARIABLES.newPassword,SETTINGS_VARIABLES.newPassword,SETTINGS_VARIABLES.ALERT_NOMATCH_MESSAGE,SETTINGS_VARIABLES.ALERT_EMPTY_MESSAGE)
        
//     })
//     // empty new password
//     it("Empty New Password",function(){
//         EmptyNewPassword(SETTINGS_VARIABLES.oldPassword,SETTINGS_VARIABLES.newPassword,SETTINGS_VARIABLES.ALERT_WEAK_MESSAGE)
